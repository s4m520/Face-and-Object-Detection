...
This project demonstrates a hybrid detection system built with OpenCV and Ultralytics YOLO11 (You Only Look Once v11) in Python.
...
- **Object Detection:** Identifies and labels up to 80 object classes using the Ultralytics YOLO11n deep-learning model.
